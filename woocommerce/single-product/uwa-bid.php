...
<?php if (($product->is_woo_ua_closed() === FALSE) and ($product->is_woo_ua_started() === TRUE)) : ?>
    ...
    <div class="uwa_auction_time" id="uwa_auction_countdown">
        ...
        <div class="uwa-main-auction-product uwa_auction_product_countdown"
             data-time="<?php echo $product->get_woo_ua_remaining_seconds() ?>"
    ...
    <div class='uwa_auction_product_ajax_change'>
        ...
        <form class="row" method="post" enctype='multipart/form-data'
            ...
            <fieldset class="form-group col-lg-12">
                ...
                <input id="uwa_your_bid"
                       type="number" name="uwa_bid_value" data-auction-id="<?php echo esc_attr($product_id); ?>"
                       value=""
                       min="<?php echo $product->woo_ua_bid_value() ?>"
                       step="any"
                       size="<?php echo strlen($product->get_woo_ua_current_bid()) + 2 ?>"
                       title="bid"
            ...
            <div class="uwa_inc_price_hint col-lg-12">
