...
<form class="row" action="" method="post" <?php do_action( 'woocommerce_edit_account_form_tag' ); ?> >

	<?php do_action( 'woocommerce_edit_account_form_start' ); ?>

	<fieldset class="col-12 col-lg-6 form-group">
	...
	<fieldset class="col-12 form-group">
        ...
        <span><small><em><?php esc_html_e( 'This will be how your name will be displayed in the account section and in reviews', 'woocommerce' ); ?></em></small></span>
	</fieldset>
    ...
    <fieldset class="col-12 form-group">
        <button type="submit" class="btn btn-primary w-100" name="save_account_details" value="<?php esc_attr_e( 'Save changes', 'woocommerce' ); ?>"><?php esc_html_e( 'Save changes', 'woocommerce' ); ?></button>
