...
<form id="order_review" method="post">
	...
	<table class="shop_table">
		<thead>
			<tr>
				<th class="product-name"><?php esc_html_e( 'Product', 'hs' ); ?></th>
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'hs' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'hs' ); ?></th>
			</tr>
		</thead>
		<tbody>
