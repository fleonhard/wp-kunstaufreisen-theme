...
<!--                                Tag --><?//= kar_get_travel_day() ?>
        ...
        <div class="col-12 text-muted px-0">
            <?php echo
            do_shortcode(kar_get_audio_as_shortcode(get_the_content()));
            ?>
        </div>
        <div class="col-12">
