        ...
        <div class="row no-gutters">
            ...
            <div class="col-12">
                <div class="embed-responsive embed-responsive-16by9">
                    <img src="<?= get_the_post_thumbnail_url() ?>" class="img-fit embed-responsive-item" alt="<?= get_the_post_thumbnail_caption() ?>">
            ...
            <div class="col-12">
                <div class="card-body">
                    <a href="<?= get_the_permalink() ?>" class="text-primary"><h5 class="card-title article-font"><?= get_the_title() ?></h5></a>
