...
<div class="card post-podcast">
    <div class="row no-gutters">
        ...
        <? endif; ?>
        <div class="col-12 <?= has_post_thumbnail() ? 'col-md-10' : '' ?>">
            <div class="card-body pb-0">
                <div class="row">
                    <div class="col-12 col-md-6 mb-0 mb-md-2">
                        <div class="text-muted"><?= kar_get_taxonomies('podcast_series') ?></div>
                        <a href="<?= get_the_permalink() ?>" class="kar-text-link">
        ...
        <div class="col-12 text-muted px-0">
            <?= do_shortcode(kar_get_shortcode(get_the_content(), 'audio')); ?>
        </div>
        <div class="col-12">
