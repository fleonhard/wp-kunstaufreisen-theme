 ...
 */
		...
		jQuery(document).ready(function ($) {
			function createFullscreenImageModal(imgEl, src) {
				if ($('#modal').length) return; //const imgEl = imgEl.is('img') ? imgEl : $(imgEl).data('img');

				var modal = document.createElement('div');
				modal.id = "modal";
				var modalImg = $(imgEl).clone();
				modalImg.attr('src', src);
				var x = document.createElement('span');
				var parent = $(imgEl).parent()[0];
				x.innerHTML = '&times';
  ...
  \**************************/
	...
	/***/ (function (module, exports, __webpack_require__) {
		...
		module.exports = __webpack_require__(/*! /Users/florianherborn/docker/wordpress/wp/wp-content/themes/kar-theme/src/art.js */"./src/art.js");
